...
export default function GameGrid() {
  ...
  // Grid's absolute screen position (measured via measureInWindow after layout).
  // pageX/pageY and measureInWindow are in the same coordinate space on RN 0.81.
  ...
  // Measure the grid's absolute screen position once after each puzzle layout.
  // Used to convert pageX/pageY → grid-local coordinates in GRANT.
  useEffect(() => {
    if (!puzzle) return;
